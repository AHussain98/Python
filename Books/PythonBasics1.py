...
# classes are optional in Python, inherited classes search their superclasses one by one and stop when they reach the accessed method
...
class myClass:
    def __init__(self, value):
        self.data = value  # data is a data member of the class, initialised in constructor
    def __add__(self, other):
        return self.data + other
    def __str__(self):  # this is whats returned if the class is printed or turned into a string object
        return "myClass as a string"

test1 = myClass(5)
print(test1 + 10) # returns 15
print(str(test1))
...
# not built-in or reserved names; Python just runs them automatically when an instance appears in the corresponding operation. Python itself defines the mappings
